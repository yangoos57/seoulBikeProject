...
여행에 적합한 대여소만 선별하기 위해 중첩 대여소를 제거해야했습니다. 다만 대여소를 정제하는 과정에서 왼편 지도와 같이 한 방향으로 대여소가 추천되는 상황이 일어나지 않도록 해야했습니다. 오른편 지도와 같이 다양한 경로를 이용해 집 주변을 탐방할 수 있도록 대여소를 추천해야 했습니다.
...
두 번의 kmeans를 적용하여 세부 방향은 보존하되 중첩 대여소를 제거할 수 있었습니다.

...
<p style='font-size:60px; text-align:center; font-weight:bold;'>따릉이로 동네투어</p>
</br>
<div align='center'>
...
<p style='font-size:30px; text-align:center; font-weight:bold; background-color : #4FC27630'>따릉이로 주변 동네를 탐방하며 여행하는 기분을 느껴보세요!</p>
</br>
</br>
...
<p style='font-size:20px; text-align:center; font-weight:bold;'>목적지까지 본인만의 경로로 이동하며 동네의 새로운 모습을 발견하세요!</p>

## 사용법 소개

1. **자주 이용하는 대여소 또는 이용하고 싶은 대여소를 검색하세요.** 위치 검색을 허용하면 집 주변 따릉이 대여소를 보여줍니다.

2. **목적지를 선택하기 전에 가고싶은 방향을 먼저 생각하세요.** 동네여행의 재미는 목적지로 이동하는 **과정**에서 얻게됩니다. 목적지는 해당 방향으로 이동하기 위한 참조점입니다.

3. **대여소를 선택하세요.** 추천된 대여소는 따릉이로 이동할 수 있도록 정제된 대여소입니다. 어느 대여소를 택하더라도 따릉이로 여행을 즐길 수 있습니다.
...
7. <span style="color : orange; font-weight :bold">여행 준비는 끝났습니다. 이제 따릉이를 빌리고 마음이 끌리는 길을 따라 목적지까지 여행하세요!</span>

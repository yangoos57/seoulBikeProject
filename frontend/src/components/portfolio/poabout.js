  ...
  return (
    <>
      ...
      <div className="mb-2" style={{ wordSpacing: "1px", letterSpacing: "1px" }}>
        ...
        비지니스 문제해결능력과 MVP 개발 역량을 갖추기 위해 개인 커리큘럼을 구상하고 프로젝트를 진행했습니다.
      ...
      웹 개발에 개인적인 관심도 있었던 찰나에 공부할만한 좋은 명분이 생겨서 배우게 됐다.
        */}
        ...
        데이터 분야에서 이루고 싶은 목표가 있습니다. 데이터팀 신설부터 시작해 체계가 갖춰진 조직으로 성장시키는 경험을
        하고 싶습니다. 언제든 기회가 찾아 온다는 마음가짐으로 꾸준히 준비해나가고 있습니다.

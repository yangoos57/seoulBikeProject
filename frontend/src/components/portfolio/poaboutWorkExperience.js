          ...
          <div className="d-flex flex-column ">
            ...
            <ul>
              <li className="me-auto">
                실시간 수집 데이터를 바탕으로 위협상황을 분석하여 지휘관의 실시간 의사결정에 필요한 정보 지원
              </li>
              <li className="me-auto">
                적 항공기 기동 패턴 분석 및 이동 경로 예측 등 지휘관이 실질적 액션을 할 수 있는 인사이트 도출
              </li>
              <li className="me-auto">
                조종사, 항공관제사, 육해군 유관부서 등 다양한 직군의 구성원들과 협업해 문제해결방안 도출{" "}
              </li>
              {/* <li className="me-auto">

            ...
            <div className="me-auto mb-3">
              ...
              <div className="me-auto">
                <ul>
                  ...
                  <li className="me-auto">대여소 추천 시스템 구현 시 상관관계 분석, Kmeans, DBSCAN 적용 </li>
                  <li className="me-auto">프로젝트 결과물을 활용할 수 있도록 웹 어플리케이션으로 제작</li>
                </ul>{" "}
              </div>
            </div>
            <div className="me-auto">
              ...
              <div className="me-auto">
                <ul>
                  ...
                  <li className="me-auto">
                    사용자에게 다양한 방향의 목적지 추천 및 중첩 추천된 대여소 제거를 위해 KMeans 활용
                  </li>
                  <li className="me-auto">
            ...
            <div className="me-auto">
              ...
              <div className="me-auto">
                <ul>
                  ...
                  <li className="me-auto">
                    TF-IDF, Word2Vec, Bert에 대한 이론 학습 및 실제 적용하는 과정을 통해 모델별 장단점 이해
                  </li>
                  <li className="me-auto">
                    데이터 수집 과정에 Multi-Threading을 적용해 기존 대비 80% 이상 처리 시간 단축
                  </li>
                  <li className="me-auto">Docker-Compose를 활용해 Django와 MySQL을 연동한 웹어플리케이션 구현</li>
                </ul>
              </div>
            </div>
            <div className="me-auto mb-3">
              ...
              <div>
                ...
                &nbsp;
                <span class="badge badgeColor">Pandas</span>
                &nbsp;
              </div>
            </div>
          </div>

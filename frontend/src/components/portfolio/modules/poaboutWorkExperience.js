        ...
        <div className="d-flex flex-column" style={{ fontSize: "17px" }}>
          ...
          <div className="d-flex flex-column mb-5">
            ...
            <ul>
              ...
              <li>연간작전계획 및 조종사 임무계획 수립 시 주요 근거자료로 활용되는 무기효과 분석자료 생산</li>
          ...
          <div className="d-flex flex-column ">
            ...
            <div className="me-auto mb-4" style={{ color: "gray" }}>
              데이터 분석가 <span style={{ fontsize: "14px !important" }}> 2020.1. - 2021.5.</span>
            </div>
            <div className="me-auto mb-3">
              <div className="me-auto h6 NotoBold">업무 소개</div>
            ...
            <ul>
              ...
              <li className="me-auto">
                일일단위로 위협상황과 특이활동을 요약한 정보보고서 작성 및 관련 내용 핵심 지휘부에 보고
              </li>
            </ul>
          </div>
        </div>

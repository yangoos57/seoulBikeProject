      ...
      <div className="flex-column">
        ...
        <div className="d-flex justify-content-between">
          {/* <div className="h6 my-auto ms-0" style={{ lineHeight: "30px" }}>
            프로젝트를 진행하며 데이터 분석, 머신러닝 파이프라인 구축, 웹 애플리케이션 개발부터 배포까지 전 과정을
            경험했습니다.
          </div> */}
        </div>
        ...
        <div className="d-flex flex-column" style={{ fontSize: "17px" }}>
          ...
          <div className="d-flex flex-column  mb-5">
            <div className="me-auto mb-1 h5 NotoBold">
              따릉이 대여기록 기반 자전거 여행지 추천
              <a
                href="https://github.com/yangoos57/seoulBikeProject"
                target="_blank"
                rel="noopener noreferrer"
                className="poGithubIcon ms-2">
                <i className="fa-brands fa-github fa-lg" style={{ color: "var(--identity-color)" }}></i>
              </a>
            </div>
            <div className="me-auto mb-4" style={{ color: "gray" }}>
              <span style={{ fontsize: "14px !important" }}> 2022.06. - 2022.08.</span>
            </div>
              ...
              <div className="me-auto">
                <ul>
                  <li className="me-auto">
                    2,700만 건의 따릉이 대여기록을 분석해 동네 여행에 적합한 따릉이 대여소 추천
                  </li>
                  <li className="me-auto">KMeans, DBSCAN, 상관관계 분석을 활용해 대여소 추천 시스템 구현</li>
                  <li className="me-auto">프로젝트 결과물을 실제 활용할 수 있도록 웹 애플리케이션으로 제작</li>
                </ul>{" "}
              </div>
            </div>
            <div className="me-auto">
              ...
              <div className="me-auto">
                <ul>
                  <li className="me-auto">
                    EDA를 통해 대여소 고도차이와 대여기록 간 상관관계 파악, 이를 데이터 전처리에 활용
                  </li>
                  <li className="me-auto">
                    다양한 방향에 위치한 목적지 추천 및 중첩 추천된 대여소 제거를 위해 KMeans 활용
                  </li>
                  <li className="me-auto">
                  ...
                  <li className="me-auto">
                    지리공간 분석 경험 및 분석 결과를 지도에 반영하기 위한 시각화 툴(Leaflet.js, plotly) 숙달
                  </li>
                  <li className="me-auto">
                    React와 Django 연동 목적 REST API 활용 및 HTTP 규약, CORS 등 관련 내용 학습{" "}
                  </li>
                  <li className="me-auto">Docker와 Azure를 활용해 웹 애플리케이션 배포 및 트러블 슈팅</li>
                </ul>
              </div>
            </div>
            <div className="me-auto mb-3">
              ...
              <div>
                ...
                <span class="badge badgeColor">Azure</span>&nbsp;<span class="badge badgeColor">Pandas</span>
                &nbsp;
                <span class="badge badgeColor">Numpy</span>
                &nbsp;
              </div>
            </div>
          </div>
          ...
          <div className="d-flex flex-column">
            ...
            <div className="me-auto">
              ...
              <div className="me-auto">
                <ul>
                  <li className="me-auto">
                    Word2vec 활용, 사용자 검색 키워드와 연관성 높은 키워드를 추출하여 도서 검색 정확도 개선
                  </li>
                  <li className="me-auto">
                    TF-IDF, Word2Vec, Bert에 대한 이론 학습 및 실제 적용하는 과정을 통해 모델 장단점 이해
                  </li>
                  <li className="me-auto">
                    도서 핵심 키워드 추출 성능 향상을 위한 Konlpy 형태소 분석, stopwords 제거 등 전처리 수행
                  </li>
                  <li className="me-auto">
                    데이터 수집 과정에 Multi-Threading을 적용해 기존 대비 80% 이상 처리 시간 단축
                  </li>
                  <li className="me-auto">
                    crontab 활용, 월 단위로 머신러닝 파이프라인을 가동하는 batch 프로세스 구축
                  </li>
                  <li className="me-auto">Docker-Compose를 활용해 Django와 MySQL이 연동된 웹애플리케이션 구현</li>
                </ul>
              </div>
            </div>
            <div className="me-auto mb-3">

    ...
    <PoMainFrame>
      <div className="poabout">
        ...
        <div className="mb-2" style={{ wordSpacing: "1px", letterSpacing: "1px" }}>
          ...
          비지니스 문제해결 능력 및 MVP 개발 역량을 갖추기 위해 스스로 커리큘럼을 구상하고 프로젝트를 진행했습니다.
          ...
          데이터 분야에서 이루고 싶은 목표가 있습니다. 데이터팀 신설부터 체계를 갖춘 조직으로까지 성장시켜본 경험을 얻고
          싶습니다. 언제라도 기회가 찾아 온다는 마음가짐으로 꾸준히 준비해나가고 있습니다.

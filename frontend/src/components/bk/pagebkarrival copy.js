...
function BkArrival() {
  ...
  const [onRecord, setOnRecord] = useState(undefined); // rangeslider value
            ...
            <div className="flex-container" style={{ flexBasis: "70%", position: "relative" }}>
              ...
              <div
                ...
                <div
                  ...
                  <BkRangeSlider max={120} onChange={setOnTime} unit={"분"} />
                </div>
                <div
                  className="slider"
                  style={{
                  ...
                  <BkRangeSlider max={20000} onChange={setOnRecord} unit={"건"} />
                </div>
                <div
                  className="slider"
                  style={{
